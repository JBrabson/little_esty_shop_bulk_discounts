...
nofun = Merchant.create!(name: "Nothing Exciting, Just Necessities")
tissue = Item.create!(name: "Box o' Tissues", description: "They are not scented. Not even a dollop of aloe.", unit_price: 2, merchant_id: nofun.id)
...
ii4 = InvoiceItem.create!(invoice_id: invoice1.id, item_id: tissue.id, quantity: 1, unit_price: 30, status: 2)
