...
RSpec.describe 'merchant dashboard' do
  before :each do
    ...
    @merchant2 = Merchant.create!(name: 'I Have No Hair Care(s)')
  ...
  describe "displays link to view all of that merchant's discounts" do
    it "that directs to the discounts index page" do
      expect(current_path).to eq(merchant_dashboard_index_path(@merchant1))
      expect(page).to have_link("View My Discounts", href: merchant_discounts_path(@merchant1))
